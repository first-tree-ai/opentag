...
/**
 * Outstanding invitations stay redeemable, but no route creates one: an Account administers only
 * its own Agents, so a second Workspace Admin is no longer a situation OpenTag can produce.
 */
