...
On 2026-08-20 the scoped Agent Runtime, Codex, and Claude Code suite passed 137
tests with 100% statements, branches, functions, and lines. All 241 Client tests
