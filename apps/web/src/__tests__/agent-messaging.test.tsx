...
describe("OpenTag Web App Shell", () => {
  ...
  it("creates a Feishu setup attempt only after an explicit admin click", async () => {
     ...
     * reader's language before anything is authorized — so this follows the request rather than
     * assuming Feishu. The way back to the other brand stands beside it, because a language is a
     * guess about a company rather than a fact about it.
     */
