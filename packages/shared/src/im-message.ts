...
export const ImResourceDescriptorSchema = z
  .object({
    ...
    // Provider metadata may describe an oversized resource. Admission keeps
    // the message and marks that resource unavailable instead of rejecting
    // the whole normalized event.
